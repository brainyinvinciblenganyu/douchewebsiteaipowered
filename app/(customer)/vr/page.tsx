      ...
      <main className="p-10 max-w-7xl mx-auto">
        ...
        <section className="bg-gradient-to-r from-[#0058a3] to-blue-600 rounded-2xl p-12 mb-12 text-white text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-6">
            Step into our immersive virtual reality showroom. Explore products in life-like 3D environments and experience shopping like never before.
          </p>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setSelectedProduct(null)} className="text-gray-300 hover:text-white text-2xl">
                    ✕
                  </button>
                </div>
                <p className="mt-4 text-gray-200">
                  This is a mock VR preview. 3D previews are available when the 3D assets are loaded — for now this shows a high-quality product image and an entry point for the VR experience.
                </p>
                <div className="mt-6">
                  <button className="bg-[#0058a3] text-white px-6 py-3 rounded-lg font-semibold">
                    Enter VR Mode (placeholder)
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <ul className="text-white space-y-3">
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Oculus Quest 2/3
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> HTC Vive
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Valve Index
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> PlayStation VR
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> WebXR compatible devices
                </li>
              </ul>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <ul className="text-white space-y-3">
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Chrome 90+ (recommended)
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Firefox 88+
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Edge 90+
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> WebXR enabled
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Modern GPU recommended
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span> Secure Connection (HTTPS) required
                </li>
              </ul>
            </div>
          </div>
